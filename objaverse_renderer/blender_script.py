...
def render_object(
    ...
    metadata['cam_fov_x'] = cam.data.angle_x
    metadata['cam_fov_y'] = cam.data.angle_y
    metadata['cam_focal_length_mm'] = cam.data.lens  # in mm
    metadata['cam_sensor_width'] = cam.data.sensor_width  # in mm
    metadata['cam_sensor_height'] = cam.data.sensor_height  # in mm
