...
class FeatureFieldModel(NerfactoModel):
    ...
    def populate_modules(self):
        ...
        self.feature_field = FeatureField(
            ...
            grid_feature_path=self.config.grid_feature_path,
        )
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        ### feature field is defined under feature_field.py
        grid_features = self.renderer_feature(features=ff_outputs[FeatureFieldHeadNames.GRID_FEATURES], weights=weights)
        outputs = {
            "rgb": rgb,
    ...
    def get_outputs_for_camera_ray_bundle(self, camera_ray_bundle: RayBundle) -> Dict[str, torch.Tensor]:
        ...
        outputs["grid_features_pca"], viewer_utils.pca_proj, *_ = apply_pca_colormap_return_proj(
            outputs["grid_features"], viewer_utils.pca_proj
        )
        ...
        outputs["similarity"] = self.get_sim(clip_features)


        grid_clip_features = outputs["grid_features"]
        outputs["grid_similarity"] = self.get_sim(grid_clip_features)
