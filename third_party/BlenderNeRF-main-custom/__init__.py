...
# blender info
bl_info = {
    'name': 'BlenderNeRF-Custom',
    'description': 'Easy NeRF synthetic dataset creation within Blender (Custom Version)',
    'author': 'Maxime Raafat, Modified by You',
    'version': (6, 0, 1),
    'blender': (4, 0, 0),
    'location': '3D View > N panel > BlenderNeRF-Custom',
...
PROPS = [
    ...
    ('sphere_radius_min', bpy.props.FloatProperty(name='Min Radius', description='Minimum radius of the training sphere', default=3.5, soft_min=0.01, unit='LENGTH', update=helper.properties_ui_upd) ),
    ('sphere_radius_max', bpy.props.FloatProperty(name='Max Radius', description='Maximum radius of the training sphere', default=4.5, soft_min=0.01, unit='LENGTH', update=helper.properties_ui_upd) ),
    ('sphere_radius', bpy.props.FloatProperty(name='Radius', description='Radius scale of the training sphere (for visualization)', default=4.0, soft_min=0.01, unit='LENGTH', update=helper.properties_ui_upd) ),
